...
class HotTop extends StatefulWidget {
  const HotTop({ super.key });

  @override
  State<HotTop> createState() => _HotTopState();
}
...
class _HotTopState extends State<HotTop> with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    ...
    // 确保 context 安全
    Future.microtask(() {
      context.read<HomeProvider>().loadHotTop();
    });
  }
              ...
              child: Skeletonizer(
                ...
                child: SizedBox(
                  ...
                  child: PageView.builder(
                    ...
                    padEnds: false,
                    itemCount: loading ? 1 : 4,
                    itemBuilder: (context, pageIndex) {
                      final start = pageIndex * pageSize;
                      final end = (start + pageSize).clamp(0, hot.length);
                      final pageSongs = hot.sublist(start, end);
                      return Padding(
