...
class ArtistAlbumAll extends StatefulWidget {
  ...
  const ArtistAlbumAll({super.key,  required this.artistId, required this.artistName });
...
class _ArtistAlbumAllState extends State<ArtistAlbumAll> {
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              delegate: SliverChildBuilderDelegate(
                    (context, index) {
                  return Center(
                      child: _buildAlbumItem(list[index])
                  );
                },
  ...
  Widget _buildAlbumItem(AlbumOfArtistDetail album) {
    return SizedBox(
      width: 180,
      child: Column(
        ...
        children: [
          ...
          /// 标题
          Padding(
            padding: EdgeInsets.symmetric(horizontal: YMusicSpacing.sm),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(
  ...
  Widget _buildBottomLoader(ArtistAllAlbumProvider provider) {
